...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        long minutesLeftForBoarding = info.getMinutesUntilBoarding();
        long hoursUntilBoarding = TimeUnit.MINUTES.toHours(minutesLeftForBoarding);
        long minutesLessHoursUntilBoarding =
                minutesLeftForBoarding - TimeUnit.HOURS.toMinutes(hoursUntilBoarding);
